...
use ImagickPixel;
use Ayim\Glide\GlideImage;
use Ayim\MediaLibrary\Conversion\Conversion;
use Ayim\MediaLibrary\Conversion\ConversionCollection;
use Ayim\MediaLibrary\Events\ConversionHasBeenCompleted;
use Ayim\MediaLibrary\Helpers\File as MediaLibraryFileHelper;
use Ayim\MediaLibrary\Jobs\PerformConversions;
use Ayim\PdfToImage\Pdf;
...
class FileManipulator
{
     ...
     *
     * @param \Ayim\MediaLibrary\Conversion\ConversionCollection $conversions
     * @param \Ayim\MediaLibrary\Media                           $media
     */
