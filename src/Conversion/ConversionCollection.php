...
namespace Ayim\MediaLibrary\Conversion;

use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use Illuminate\Database\Eloquent\Relations\Relation;
use Ayim\MediaLibrary\Exceptions\InvalidConversion;
use Ayim\MediaLibrary\HasMedia\Interfaces\HasMediaConversions;
...
class ConversionCollection extends Collection
{
     ...
     * @return mixed
     *
     * @throws \Ayim\MediaLibrary\Exceptions\InvalidConversion
     */
