...
namespace Ayim\MediaLibrary\HasMedia;

use Illuminate\Support\Collection;
use Ayim\MediaLibrary\Conversion\Conversion;
use Ayim\MediaLibrary\Events\CollectionHasBeenCleared;
use Ayim\MediaLibrary\Exceptions\FileCannotBeAdded;
use Ayim\Medialibrary\Exceptions\MediaCannotBeDeleted;
use Ayim\Medialibrary\Exceptions\MediaCannotBeUpdated;
use Ayim\MediaLibrary\FileAdder\FileAdderFactory;
use Ayim\MediaLibrary\Filesystem;
...
trait HasMediaTrait
{
     ...
     * @return array
     *
     * @throws \Ayim\Medialibrary\Exceptions\MediaCannotBeUpdated
     */
     ...
     *
     * @param int|\Ayim\MediaLibrary\Media $mediaId
     *
     * @throws \Ayim\Medialibrary\Exceptions\MediaCannotBeDeleted
     */
     ...
     *
     * @return \Ayim\MediaLibrary\Media
     */
